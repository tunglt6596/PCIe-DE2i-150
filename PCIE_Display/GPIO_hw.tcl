...
add_fileset_file gpio.v VERILOG PATH ip_repo/gpio/gpio.v TOP_LEVEL_FILE
...
add_interface_port s0 write_n write_n Input 1
add_interface_port s0 address address Input 1
