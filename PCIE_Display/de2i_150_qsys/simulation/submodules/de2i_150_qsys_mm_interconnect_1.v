...
module de2i_150_qsys_mm_interconnect_1 (
	...
	wire  [109:0] alt_vip_vfr_0_avalon_slave_agent_rf_source_data;                   // alt_vip_vfr_0_avalon_slave_agent:rf_source_data -> alt_vip_vfr_0_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [109:0] alt_vip_vfr_0_avalon_slave_agent_rsp_fifo_out_data;                // alt_vip_vfr_0_avalon_slave_agent_rsp_fifo:out_data -> alt_vip_vfr_0_avalon_slave_agent:rf_sink_data
	...
	wire          alt_vip_vfr_0_avalon_slave_agent_rp_valid;                         // alt_vip_vfr_0_avalon_slave_agent:rp_valid -> router_001:sink_valid
	wire  [108:0] alt_vip_vfr_0_avalon_slave_agent_rp_data;                          // alt_vip_vfr_0_avalon_slave_agent:rp_data -> router_001:sink_data
	wire          alt_vip_vfr_0_avalon_slave_agent_rp_ready;                         // router_001:sink_ready -> alt_vip_vfr_0_avalon_slave_agent:rp_ready
	wire          alt_vip_vfr_0_avalon_slave_agent_rp_startofpacket;                 // alt_vip_vfr_0_avalon_slave_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          alt_vip_vfr_0_avalon_slave_agent_rp_endofpacket;                   // alt_vip_vfr_0_avalon_slave_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [108:0] alt_vip_vfr_0_avalon_slave_burst_adapter_source0_data;             // alt_vip_vfr_0_avalon_slave_burst_adapter:source0_data -> alt_vip_vfr_0_avalon_slave_agent:cp_data
	...
	wire    [0:0] alt_vip_vfr_0_avalon_slave_burst_adapter_source0_channel;          // alt_vip_vfr_0_avalon_slave_burst_adapter:source0_channel -> alt_vip_vfr_0_avalon_slave_agent:cp_channel
	...
	wire          router_001_src_valid;                                              // router_001:src_valid -> alt_vip_vfr_0_avalon_slave_rsp_width_adapter:in_valid
	wire  [108:0] router_001_src_data;                                               // router_001:src_data -> alt_vip_vfr_0_avalon_slave_rsp_width_adapter:in_data
	wire          router_001_src_ready;                                              // alt_vip_vfr_0_avalon_slave_rsp_width_adapter:in_ready -> router_001:src_ready
	wire    [0:0] router_001_src_channel;                                            // router_001:src_channel -> alt_vip_vfr_0_avalon_slave_rsp_width_adapter:in_channel
	wire          router_001_src_startofpacket;                                      // router_001:src_startofpacket -> alt_vip_vfr_0_avalon_slave_rsp_width_adapter:in_startofpacket
	wire          router_001_src_endofpacket;                                        // router_001:src_endofpacket -> alt_vip_vfr_0_avalon_slave_rsp_width_adapter:in_endofpacket
	wire          alt_vip_vfr_0_avalon_slave_rsp_width_adapter_src_valid;            // alt_vip_vfr_0_avalon_slave_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [144:0] alt_vip_vfr_0_avalon_slave_rsp_width_adapter_src_data;             // alt_vip_vfr_0_avalon_slave_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          alt_vip_vfr_0_avalon_slave_rsp_width_adapter_src_ready;            // rsp_demux:sink_ready -> alt_vip_vfr_0_avalon_slave_rsp_width_adapter:out_ready
	wire    [0:0] alt_vip_vfr_0_avalon_slave_rsp_width_adapter_src_channel;          // alt_vip_vfr_0_avalon_slave_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          alt_vip_vfr_0_avalon_slave_rsp_width_adapter_src_startofpacket;    // alt_vip_vfr_0_avalon_slave_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          alt_vip_vfr_0_avalon_slave_rsp_width_adapter_src_endofpacket;      // alt_vip_vfr_0_avalon_slave_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          cmd_mux_src_valid;                                                 // cmd_mux:src_valid -> alt_vip_vfr_0_avalon_slave_cmd_width_adapter:in_valid
	wire  [144:0] cmd_mux_src_data;                                                  // cmd_mux:src_data -> alt_vip_vfr_0_avalon_slave_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                 // alt_vip_vfr_0_avalon_slave_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [0:0] cmd_mux_src_channel;                                               // cmd_mux:src_channel -> alt_vip_vfr_0_avalon_slave_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                         // cmd_mux:src_startofpacket -> alt_vip_vfr_0_avalon_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                           // cmd_mux:src_endofpacket -> alt_vip_vfr_0_avalon_slave_cmd_width_adapter:in_endofpacket
	...
	wire  [108:0] alt_vip_vfr_0_avalon_slave_cmd_width_adapter_src_data;             // alt_vip_vfr_0_avalon_slave_cmd_width_adapter:out_data -> alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_data
	...
	wire    [0:0] alt_vip_vfr_0_avalon_slave_cmd_width_adapter_src_channel;          // alt_vip_vfr_0_avalon_slave_cmd_width_adapter:out_channel -> alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_channel
